...
public sealed class ProductTests
{
    ...
    public void Constructor_creates_valid_active_product()
    {
        ...
        var product = new Product("SKU-001", "Mechanical Keyboard", 249.90m);
    ...
    {
        var product = new Product("SKU-001", "Original Name", 100m);
    ...
    public void Constructor_rejects_non_positive_price(decimal price)
    {
        Assert.Throws<ArgumentOutOfRangeException>(
            () => new Product("SKU-001", "Product", price));
    }
}
